...
Scenario: Using the API without Accept Header
	...
	And the "detail" property exists
	And the "detail" property is a string equalling "You havn't specified the API version in the Accept Header. You have to use Accept application/vnd.api+json, application/vnd.api+json; net.youthweb.api.version=0.12"
...
Scenario: Using the API with deprecated version parameter
	...
	And the "warnings" property contains at least:
		"""
		You have specified a deprecated API version. Please use the current API version 0.12
		"""
...
Scenario: Using the API with unsupported version parameter
	...
	And the "title" property is a string equalling "Not Acceptable"
	And the "detail" property exists
	And the "detail" property is a string equalling "You have specified an unsupported API version. Please use the current API version 0.12"
